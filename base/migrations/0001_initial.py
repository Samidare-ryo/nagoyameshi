    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id",
                    models.CharField(
                        default=base.models.member_models.member_pk,
                        editable=False,
                        max_length=36,
                        primary_key=True,
                        serialize=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(blank=True, unique=True, verbose_name="スラッグ"),
                ),
            ],
            options={
                "verbose_name": "カテゴリ",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(
                        default=base.models.restaurant_models.restaurant_pk,
                        editable=False,
                        max_length=36,
                        primary_key=True,
                        serialize=False,
                ...
                (
                    "regular_holiday",
                    models.ManyToManyField(default=0, to="base.holiday"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_card_last4",
                    models.CharField(
                        blank=True, max_length=4, null=True, verbose_name="カード下4桁"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(
                        default=base.models.review_models.review_pk,
                        editable=False,
                        max_length=36,
                        primary_key=True,
                        serialize=False,
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to=base.models.restaurant_models.upload_image_to,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, null=True, to="base.specialholiday"
            ),
        ),
        migrations.AddField(
            model_name="restaurant",
            name="tags",
            field=models.ManyToManyField(
                blank=True, related_name="restaurants", to="base.tag"
            ),
        ),
        migrations.CreateModel(
            name="Reservation",
            fields=[
                (
                    "id",
                    models.CharField(
                        default=base.models.reservation_models.reservation_pk,
                        editable=False,
                        max_length=30,
                        primary_key=True,
                        serialize=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "notification_id",
                    models.CharField(
                        default=base.models.notification_models.notification_pk,
                        max_length=20,
                        primary_key=True,
                        serialize=False,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(
                        default=base.models.favorite_models.favorite_pk,
                        editable=False,
                        max_length=30,
                        primary_key=True,
                        serialize=False,
